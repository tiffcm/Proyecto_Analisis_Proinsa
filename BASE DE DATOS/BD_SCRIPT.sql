...
GO
INSERT [dbo].[AspNetUserLogins] ([LoginProvider], [ProviderKey], [ProviderDisplayName], [UserId]) VALUES (N'Microsoft', N'369d841c-b981-4a4d-b408-56902a92632b', N'Microsoft', N'68946acd-d63a-4318-8061-b8dd1006c2d1')
...
INSERT [dbo].[AspNetUserRoles] ([UserId], [RoleId]) VALUES (N'68946acd-d63a-4318-8061-b8dd1006c2d1', N'2')
GO
...
INSERT [dbo].[AspNetUsers] ([Id], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) VALUES (N'68946acd-d63a-4318-8061-b8dd1006c2d1', N'Practicante1@proinsalat.com', N'PRACTICANTE1@PROINSALAT.COM', N'Practicante1@proinsalat.com', N'PRACTICANTE1@PROINSALAT.COM', 0, NULL, N'WGHMZTDYAVG6LOFZHLJAXWY4AE24VEW6', N'04b9c604-a07c-44a8-8f91-015b1d9a55c4', NULL, 0, 0, NULL, 1, 0)
GO
...
INSERT [dbo].[CORREO] ([ID_CORREO], [CORREO]) VALUES (7, N'Practicante1@proinsalat.com')
...
INSERT [dbo].[EMPLEADO] ([ID_EMPLEADO], [IDENTIFICACION], [NOMBRECOMPLETO], [FECHA_NACIMIENTO], [FECHA_INGRESO], [FOTO], [SALARIO], [SALDO_VACACIONES], [CARGO_ID], [CORREO_ID], [HORARIOLABORAL_ID], [DEPARTAMENTO_ID], [ESTADO]) VALUES (4, 305070198, N'TIFFANY CAMACHO MONGE', CAST(N'2012-12-12T00:00:00.000' AS DateTime), CAST(N'2020-12-12T00:00:00.000' AS DateTime), N'AKDJBAKDBAD', CAST(20000.00 AS Decimal(10, 2)), 2, 1, 7, 1, 2, 1)
SET IDENTITY_INSERT [dbo].[EMPLEADO] OFF
GO
SET IDENTITY_INSERT [dbo].[EMPLEADODIRRECCION] ON 

INSERT [dbo].[EMPLEADODIRRECCION] ([ID_EMPLEADODIRRECCION], [EMPLEADO_ID], [DIRRECION_ID]) VALUES (1, 1, 1)
INSERT [dbo].[EMPLEADODIRRECCION] ([ID_EMPLEADODIRRECCION], [EMPLEADO_ID], [DIRRECION_ID]) VALUES (2, 3, 2)
INSERT [dbo].[EMPLEADODIRRECCION] ([ID_EMPLEADODIRRECCION], [EMPLEADO_ID], [DIRRECION_ID]) VALUES (4, 4, 1)
SET IDENTITY_INSERT [dbo].[EMPLEADODIRRECCION] OFF
GO
SET IDENTITY_INSERT [dbo].[EMPLEADOTELEFONO] ON 

INSERT [dbo].[EMPLEADOTELEFONO] ([ID_EMPLEADOTELEFONO], [EMPLEADO_ID], [TELEFONO_ID]) VALUES (1, 1, 1)
INSERT [dbo].[EMPLEADOTELEFONO] ([ID_EMPLEADOTELEFONO], [EMPLEADO_ID], [TELEFONO_ID]) VALUES (2, 4, 2)
...
BEGIN
    ...
    SELECT E.ID_EMPLEADO,E.[IDENTIFICACION], E.[NOMBRECOMPLETO], E.[FECHA_INGRESO],
           E.[FOTO], E.[SALARIO], E.[SALDO_VACACIONES], CA.NOMBRE_CARGO, C.CORREO,
           E.[HORARIOLABORAL_ID], D.NOMBRE_DEPARTAMENTO, T.TELEFONO, DI.DIRRECION,
...
-- =============================================
CREATE PROCEDURE MostrarEmpleadoVistaAdmin
(
    @ID_EMPLEADO bigint
)
AS
...
-- =============================================
CREATE PROCEDURE MostrarInfoVistaAdmin
...
-- =============================================
CREATE PROCEDURE EditarDatosVistaAdmin
(
    -- Add the parameters for the stored procedure here
    @ID_EMPLEADO BIGINT,
    @IDENTIFICACION INT,
...
-- =============================================
CREATE PROCEDURE ObtenerTelefonosPorEmpleado
(
    -- Add the parameters for the stored procedure here
    @ID_EMPLEADO BIGINT
)
...
-- =============================================
CREATE PROCEDURE ObtenerDireccionesPorEmpleado
(
    -- Add the parameters for the stored procedure here
    @ID_EMPLEADO BIGINT
)
...
BEGIN
    ...
    -- Consultar los detalles del empleado
    SELECT e.ID_EMPLEADO , E.[IDENTIFICACION], E.[NOMBRECOMPLETO], E.[FECHA_INGRESO],
           E.[FOTO], E.[SALARIO], E.[SALDO_VACACIONES], CA.CARGO, C.CORREO,
           E.[HORARIOLABORAL_ID], D.DEPARTAMENTO, T.TELEFONO, DI.DIRRECION,
           @NOMBREROL AS NOMBREROL, @IDROL AS IDROL
    FROM [dbo].[EMPLEADO] E
    INNER JOIN CORREO C ON C.ID_CORREO = E.CORREO_ID
    INNER JOIN DEPARTAMENTO D ON E.DEPARTAMENTO_ID = D.ID_DEPARTAMENTO
...
ALTER PROCEDURE [dbo].[NotificacionSolicitud] 
...
create or alter  PROC [dbo].[ObtenerTiposSolicitudes]
as begin

select ID_TIPOSOLICITUD AS ID, NOMBRE_TIPO_SOLICITUD AS DESCRIPCION from TIPOSOLICITUD

where ID_TIPOSOLICITUD in (1,2,5)


end
go

-----Cambios para registro de solicitud de cambio de horario.

ALTER TABLE  SOLICITUD ALTER COLUMN  FECHA_INICIO DATETIME NULL

ALTER TABLE  SOLICITUD ALTER COLUMN  FECHA_FINAL DATETIME NULL

ALTER TABLE SOLICITUD ADD ID_HORARIOLABORAL BIGINT NULL

ALTER TABLE  SOLICITUD ALTER COLUMN  DIAS INT NULL
