...
namespace PROINSA_GP_WEB.Controllers
{
    public class ReportController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> DownloadReportExcel(string reportName = "ReporteEmpleados")
        {
        ...
        [HttpGet]
        public async Task<IActionResult> DownloadReportPdf(string reportName = "ReporteEmpleados")
        {
